...
class XmlMappingService
{
	...
	internal void ExportXmlData( Worksheet ws, XmlMappingInfo info )
	{
	...
	private static Func<XmlContext, object> Parse( string expressionText ) => Parse<object>( expressionText );

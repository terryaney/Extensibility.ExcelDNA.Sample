...
public static class DnaMathUtitlies
{
	...
	public static double BTRPV(
		...
		int period,
		[KatExcelArgument( 
			Description = "Required. The interest rates per period. i.e., if you obtain an automobile loan at a 10 percent annual interest rate and make monthly payments, you would enter 10%/12, or 0.83%, or 0.0083, into the formula as the rate.",
			Summary = "Required. The interest rates per period. For example, if you obtain an automobile loan at a 10 percent annual interest rate and make monthly payments, your interest rate per month is 10%/12, or 0.83%. You would enter 10%/12, or 0.83%, or 0.0083, into the formula as the rate."
		)]
		double[] interestRates,
		[KatExcelArgument( 
			Description = "Required. The payment amounts made each period. Each amount includes principal and interest (no fees or taxes). i.e., a monthly payment on a $10,000, four-year car loan at 12 percent is $263.33. You would enter -263.33 into the formula as the amount.",
			Summary = "Required. The payment amounts made each period. Typically, each amount includes principal and interest but no other fees or taxes. For example, a monthly payment on a $10,000, four-year car loan at 12 percent is $263.33. You would enter -263.33 into the formula as one of the amounts."
		)]
	...
	public static double BTRXIRR(
		[KatExcelArgument( 
			Description = "Required. A series of cash flows that corresponds to a schedule of payments in dates. The series must contain at least one positive and one negative value.  See help link for more detail.",
			Summary = "Required. A series of cash flows that corresponds to a schedule of payments in dates. The first payment is optional and corresponds to a cost or payment that occurs at the beginning of the investment. If the first value is a cost or payment, it must be a negative value. All succeeding payments are discounted based on a 365-day year. The series of values must contain at least one positive and one negative value."
		)]
		double[] values,
		[KatExcelArgument( 
			Description = "Required. A schedule of payment dates that corresponds to payments. Dates may occur in any order, should be entered by using the DATE function (not 'text'), or as results of other cells. i.e., use DATE(2008,5,23) for 5/23/2008.",

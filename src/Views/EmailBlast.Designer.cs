...
partial class EmailBlast
{
	...
	private void InitializeComponent()
	{
		...
		emailAddress.Margin = new Padding( 4, 4, 4, 4 );
		...
		audit.Margin = new Padding( 4, 4, 4, 4 );
		audit.Name = "audit";
		...
		bcc.Margin = new Padding( 4, 4, 4, 4 );
		bcc.Name = "bcc";
		...
		from.Margin = new Padding( 4, 4, 4, 4 );
		from.Name = "from";
		...
		waitMinutes.Margin = new Padding( 4, 4, 4, 4 );
		...
		addressPerEmail.Margin = new Padding( 4, 4, 4, 4 );
		...
		utilityTabsDivider.TabIndex = 27;
		// 
		// subject
		// 
		subject.Location = new Point( 18, 266 );
		subject.Margin = new Padding( 4, 4, 4, 4 );
		...
		body.Margin = new Padding( 4, 4, 4, 4 );
		body.Name = "body";
		...
		attachments.Margin = new Padding( 4, 4, 4, 4 );
		attachments.Name = "attachments";
		attachments.Size = new Size( 309, 82 );
		attachments.TabIndex = 24;
		...
		remove.Margin = new Padding( 4, 4, 4, 4 );
		remove.Name = "remove";

...
namespace Excel.AddIn.Setup
{
	...
	public class InputBox
	{
		...
		static public string Prompt( string prompt ) => Prompt( prompt, null, null, null, null );
		static public string Prompt( string prompt, string title ) => Prompt( prompt, title, null, null, null );
		static public string Prompt( string prompt, string title, string defaultValue ) => Prompt( prompt, title, defaultValue, null, null );
		static public string Prompt( string prompt, string title, string defaultValue, int? XPos, int? YPos )
		{
			var result = Show( prompt, title, defaultValue, XPos, YPos );
			return result.ReturnCode == DialogResult.OK ? result.Text : null;
		}

		static public InputBoxResult Show( string prompt ) => Show( prompt, null, null, null, null );
		static public InputBoxResult Show( string prompt, string title ) => Show( prompt, title, null, null, null );
		static public InputBoxResult Show( string prompt, string title, string defaultValue ) => Show( prompt, title, defaultValue, null, null );
		static public InputBoxResult Show( string prompt, string title, string defaultValue, int? XPos, int? YPos )
		{
			InitializeComponent();
			FormPrompt = prompt;
			FormCaption = title;
